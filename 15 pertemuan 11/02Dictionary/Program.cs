...
namespace GenericDictionaryDemo
{
    class Program
    {
        static void Main()
        {
            ...
            {
                string key = carBrands.Keys.ElementAt(i); //ElementAt is LINQ extension method that returns the element at a specific index in a collection.
                //returns the key at index i in the collection of keys for the carBrands dictionary
                string valuez = carBrands[key];
                Console.WriteLine($"Key: {key}, Value: {valuez}");
            }
            ...
            Console.WriteLine("Dictionary contains key 'Toyota': " + carBrands.ContainsKey("Toyota"));
            ...
            Console.WriteLine("\nDictionary after proses clearing :");
            foreach (KeyValuePair<string, string> KVP in carBrands)
            {
                Console.WriteLine($"Key:{KVP.Key}, Value: {KVP.Value}");
            }
            ...
            Console.WriteLine("\nDictionary after proses added Tesla :");
            foreach (KeyValuePair<string, string> KVP in carBrands)
            {
                Console.WriteLine($"Key:{KVP.Key}, Value: {KVP.Value}");
            }
